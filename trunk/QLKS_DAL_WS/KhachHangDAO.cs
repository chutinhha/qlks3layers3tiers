...
namespace DAL
{
    ...
    {
        public KhachHangDTO kDTO = new KhachHangDTO();
        ...
        public KhachHangDTO[] getListKhachHang()
        {
            ...
            //string strSQL = "SELECT KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG,LOAIKHACHHANG Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH";
        ...
        public KhachHangDTO[] getKhachHangByName(string Name)
        {
            ...
            string strSQL = "SELECT KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG,LOAIKHACHHANG Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH and KHACHHANG.TenKhachHang_EN like '" + Name + "%'";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "SELECT(SELECT COUNT(*) FROM KHACHHANG AS tmp WHERE tmp.MaKhachHang<=KHACHHANG.MaKhachHang and KHACHHANG.CMND = '" + CMND + "') as STT, KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG, LOAIKHACHHANG  Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH and  KHACHHANG.CMND = '" + CMND + "'";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "SELECT(SELECT COUNT(*) FROM KHACHHANG AS tmp WHERE tmp.MaKhachHang<=KHACHHANG.MaKhachHang and KHACHHANG.MaLoaiKH = '" + Kind + "') as STT, KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG,LOAIKHACHHANG Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH and KHACHHANG.MaLoaiKH = '" + Kind + "'";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "SELECT(SELECT COUNT(*) FROM KHACHHANG AS tmp WHERE tmp.MaKhachHang<=KHACHHANG.MaKhachHang and KHACHHANG.DiaChi = '" + Address + "') as STT, KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG,LOAIKHACHHANG Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH and KHACHHANG.MaLoaiKH = '" + Address + "'";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "SELECT(SELECT COUNT(*) FROM KHACHHANG AS tmp WHERE tmp.MaKhachHang<=KHACHHANG.MaKhachHang and KHACHHANG.DiaChi = '" + Address + "' and KHACHHANG.Name ='" + Name + "' and KHACHHANG.MaLoaiKH = '" + Kind + "') as STT, KHACHHANG.MaKhachHang, KHACHHANG.TenKhachHang, KHACHHANG.MaLoaiKH,KHACHHANG.CMND,KHACHHANG.DiaChi,KHACHHANG.KhachHangDaiDien From KHACHHANG,LOAIKHACHHANG Where KHACHHANG.MaLoaiKH = LOAIKHACHHANG.MaLoaiKH and KHACHHANG.DiaChi = '" + Address + "' and KHACHHANG.Name ='" + Name + "' and KHACHHANG.MaLoaiKH = '" + Kind + "'";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "Select Count(MaKhachHang) From KHACHHANG Where MaKhachHang='" + MaKhachHang + "'";
            int nRecord = ExcuteScalar(strSQL);
            return nRecord;
        }
        public int testExistsMaKhachHangInCTPHIEUTHUE(string MaKhachHang)
        {
            string strSQL = "Select Count(MaKhachHang) From CTPHIEUTHUE Where MaKhachHang='" + MaKhachHang + "'";
            int nRecord = ExcuteScalar(strSQL);
            return nRecord;
        }
        // Delete
        ...
        {
            string strSQL = "Delete From KHACHHANG Where KHACHHANG.MaKhachHang = '" + MaKhachHang + "'";
            return ExecuteNonQuery(strSQL,"isReturnInt");
        }
        ...
        {
            string strSQL = "Select * From KHACHHANG Where KhachHangDaiDien is NULL";
            DataTable dt = ExecuteQuery(strSQL);
            KhachHangDTO[] kDTOArr = new KhachHangDTO[dt.Rows.Count];
            for (int i = 0; i < dt.Rows.Count; i++)
            {
        ...
        {
            string strSQL = "Select KhachHangDaiDien From KHACHHANG Where MaKhachHang = '" + MaKhachHang + "' and KhachHangDaiDien is NULL";
            return getStrByString(strSQL, "KhachHangDaiDien").Equals("")?1:0;
        }
        public string getKhachHangDaiDienNotNULL(string MaKhachHang)
        {
            string strSQL = "Select * From KHACHHANG Where MaKhachHang='" + MaKhachHang + "'";
        ...
        {
            string strSQL = "Select Count(MaKhachHang) From KHACHHANG Where MaKhachHang in	(Select MaKhachHang From KHACHHANG Where KhachHangDaiDien='" + MaKhachHang + "')";
            int nRecord = ExcuteScalar(strSQL);
            if (nRecord == 0)
                return 0;
            return 1;
